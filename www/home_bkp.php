  ...
  <div class="w3-content">
    ...
    <div class="w3-center w3-xxlarge">
      ...
      <div>
        ...
        <?php
          ...
          if(isset($_POST["submit"])){
            ...
            $response = call('GET', 'https://www.weatherpi.at/REST_api.php/weather/1');
      ...
      <table>
        <tr>
          <td><b>Temp.</b></td>
          <td><?php echo $vars->temp . ' °C'; ?></td>
        </tr>
        <tr>
          <td><b>Wind</b></td><td><?php echo $vars->wind . ' km/h';  ?></td>
            <td>&nbsp;<?php echo 'aus ' . $vars->winddir;  ?></td>
        </tr>
        <tr>
          <td><b>Humidity</b></td><td><?php echo $vars->humidity . ' %';  ?></td>
        </tr>
      </table>
    </div>
